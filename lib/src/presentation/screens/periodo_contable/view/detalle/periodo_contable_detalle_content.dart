...
class PeriodoContableDetalleContent extends StatelessWidget {
  ...
  bool get _isOpen =>
      periodo.estado.trim().toUpperCase() == 'ABIERTO';

  double get _variation =>
      periodo.saldoFinal - periodo.saldoInicial;
