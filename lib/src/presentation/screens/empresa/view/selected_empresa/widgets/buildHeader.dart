...
Widget buildHeader(BuildContext context) {
  ...
  final nombres = (persona?.nombres ?? '').trim();

  final primerNombre = nombres.isNotEmpty
      ? nombres.split(RegExp(r'\s+')).first
      : 'Usuario';
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      gradient: LinearGradient(
        colors: [
          colors.primary,
          Color.lerp(colors.primary, colors.primaryContainer, 0.35) ??
              colors.primary,
        ],
    ...
    child: Column(
      ...
      children: [
        ...
        // ==================================================
        Text(
          'La empresa que elijas definirá toda la información '
          'con la que trabajarás: categorías, movimientos, '
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: colors.onPrimary.withValues(alpha: 0.10)),
          ),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Icon(Icons.swap_horiz_rounded, color: colors.onPrimary, size: 20),

              const SizedBox(width: 10),

              Expanded(
                child: Text(
                  'Podrás cambiar de empresa en cualquier momento '
                  'desde Configuración.',
