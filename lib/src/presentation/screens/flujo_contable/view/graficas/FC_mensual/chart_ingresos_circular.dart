...
class ChartIngresosCircular extends StatelessWidget {
  final List<FlujoCategoria> categorias;
  final double total;

  const ChartIngresosCircular({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    if (subcategorias.isEmpty) {
      return ChartContainer(
        ...
        subtitulo: 'Ingresos agrupados por subcategoría.',
        child: SizedBox(
          height: 220,
          child: Center(
            child: Text(
    ...
    return ChartContainer(
      titulo: 'Distribución de ingresos',
      subtitulo: 'Participación de cada subcategoría en los ingresos.',
      child: Column(
        children: [
          // ========================================================
          // GRÁFICO
