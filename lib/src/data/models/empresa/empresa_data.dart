...
class EmpresaData {
  ...
  factory EmpresaData.fromJson(Map<String, dynamic> json) {
    return EmpresaData(
      ...
      razonSocial: json['razon_social']?.toString().trim() ?? '',
      nombreComercial: json['nombre_comercial']?.toString().trim() ?? '',
      ruc: json['ruc']?.toString().trim() ?? '',
      tipoEmpresa: json['tipo_empresa']?.toString().trim() ?? '',
      direccionFiscal: json['direccion_fiscal']?.toString().trim() ?? '',
      telefono: json['telefono']?.toString().trim() ?? '',
      email: json['email']?.toString().trim() ?? '',
      paginaWeb: json['pagina_web']?.toString().trim() ?? '',
      logoUrl: json['logo_url']?.toString().trim() ?? '',
      estado: json['estado'] == true,
      activoSunat: json['activo_sunat'] == true,
